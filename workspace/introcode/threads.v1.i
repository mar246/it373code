...
void Pthread_create(pthread_t *t, const pthread_attr_t *attr,
    ...
    ((rc == 0) ? (void) (0) : __assert_fail ("rc == 0", "common_threads.h", 10, __PRETTY_FUNCTION__));
}

void Pthread_join(pthread_t thread, void **value_ptr) {
    int rc = pthread_join(thread, value_ptr);
    ((rc == 0) ? (void) (0) : __assert_fail ("rc == 0", "common_threads.h", 15, __PRETTY_FUNCTION__));
}

void Pthread_mutex_lock(pthread_mutex_t *mutex) {
    int rc = pthread_mutex_lock(mutex);
    ((rc == 0) ? (void) (0) : __assert_fail ("rc == 0", "common_threads.h", 20, __PRETTY_FUNCTION__));
}

void Pthread_mutex_unlock(pthread_mutex_t *mutex) {
    int rc = pthread_mutex_unlock(mutex);
    ((rc == 0) ? (void) (0) : __assert_fail ("rc == 0", "common_threads.h", 25, __PRETTY_FUNCTION__));
}

void Pthread_mutex_init(pthread_mutex_t *mutex, pthread_mutexattr_t *attr) {
    int rc = pthread_mutex_init(mutex, attr);
    ((rc == 0) ? (void) (0) : __assert_fail ("rc == 0", "common_threads.h", 30, __PRETTY_FUNCTION__));
}
# 4 "threads.v1.c" 2
...
int main(int argc, char *argv[]) {
 ...
 exit(1);
    ...
    Pthread_create(&p1, ((void *)0), worker, ((void *)0));
    Pthread_create(&p2, ((void *)0), worker, ((void *)0));
